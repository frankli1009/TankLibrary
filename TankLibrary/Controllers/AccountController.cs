...
namespace TankLibrary.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public UserIdentityDbContext DbContext
        {
            get
            {
                return HttpContext.GetOwinContext().Get<UserIdentityDbContext>();
            }
        }
